...
namespace ICalendarNet.Benchmarking.Data
{
    internal class SampleData
    {
        public string AmericanAwernessDays = "";
        public List<string> ICalStrings = [];
...
,
        ...
        public async Task Setup()
        {
            ...
            AmericanAwernessDays = await httpClient.GetStringAsync(BigDataCalendar);
        }

        public const string SampleRecurring = @"BEGIN:VCALENDAR
VERSION:2.0
...
END:VCALENDAR";
        ...
        public const string SampleCalendar = @"BEGIN:VCALENDAR
