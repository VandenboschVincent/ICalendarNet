...
namespace ICalendarNet.Base
{
    public interface ICalendarComponent
    {
        ...
        void UpdateProperty(string key, string value, ContentLineParameters? parameters = null);
        void UpdateProperty(string key, IEnumerable<string> value, ContentLineParameters? parameters = null);
