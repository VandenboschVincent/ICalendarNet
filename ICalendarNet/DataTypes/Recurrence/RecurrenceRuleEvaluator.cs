...
{
    public class RecurrenceRuleEvaluator : Evaluator
    {
        /// <summary>
        ...
        private CalendarRecurrenceRule Pattern { get; set; }

        protected CalendarRecurrenceRule Rule
        {
            get => Pattern;
            set => Pattern = value;
        }

        public RecurrenceRuleEvaluator(CalendarRecurrenceRule rule)
        {
            Pattern = rule;
        }

        private CalendarRecurrenceRule ProcessRecurrencePattern(DateTimeOffset referenceDate)
        {
            var r = Rule;
