...
namespace ICalendarNet.Models.DataTypes
{
    ...
    public class CalendarRecurrenceRule : ContentLine
    {
        ...
        {
            get => TypeConverters.ConvertToDateTimeOffset(ValueParameters.GetValue("UNTIL"), GetTimeZone());
            set => ValueParameters.SetOrAddValue("UNTIL", value.HasValue ? TypeConverters.ConvertFromDateTimeOffset(value.Value, GetTimeZone()) : null);
        }
