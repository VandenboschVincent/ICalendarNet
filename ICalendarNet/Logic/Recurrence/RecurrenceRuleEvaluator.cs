...
{
    public static class RecurrenceRuleEvaluator
    {
        /// <summary>
        ...
        private static CalendarRecurrenceRule ProcessRecurrencePattern(DateTimeOffset referenceDate, CalendarRecurrenceRule r)
        {
        ...
        private static IEnumerable<DateTimeOffset> EnumerateDates(DateTimeOffset originalDate, DateTimeOffset intervalRefTime, CalendarRecurrenceRule pattern, EvaluationOptions? options)
        {
            ...
            while (true)
            {
                ...
                if (noCandidateIncrementCount > options?.MaxUnmatchedIncrementsLimit)
                    throw new ArgumentException("Maximum unmatched increments limit exceeded.");
        ...
        /// </remarks>
        private static DateTimeOffset GetIntervalLowerLimit(DateTimeOffset intervalRefTime, CalendarRecurrenceRule pattern, DateTimeOffset originalDate)
        {
            switch (pattern)
            {
        ...
        /// <param name="pattern"></param>
        private static IEnumerable<DateTimeOffset> ApplySetPosRules(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetMonthVariants(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern, bool? expand)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetWeekNoVariants(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern, bool? expand, ref ExpandContext expandContext)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetWeekNoVariantsExpanded(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern)
        {
        ...
        /// </returns>
        private static IEnumerable<DateTimeOffset> GetYearDayVariants(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern, bool? expand, ref ExpandContext expandContext)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetYearDayVariantsExpanded(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetYearDayVariantsLimited(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern)
        {
            foreach (var date in dates)
            {
                var candidates =
        ...
        private static IEnumerable<DateTimeOffset> GetMonthDayVariants(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern, bool? expand, ref ExpandContext expandContext)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetMonthDayVariantsLimited(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetMonthDayVariantsExpanded(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern)
        {
            foreach (var date in dates)
            {
        ...
        private static IEnumerable<DateTimeOffset> GetDayVariants(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern, bool? expand, ref ExpandContext expandContext)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetDayVariantsLimited(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern)
            =>
        ...
        private static IEnumerable<DateTimeOffset> GetDayVariantsExpanded(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern)
        {
            foreach (var date in dates)
            {
                var weekDayDates = new SortedSet<DateTimeOffset>(); // SortedSet uses DateTimeOffset.CompareTo
        ...
        private static IEnumerable<DateTimeOffset> GetAbsWeekDays(DateTimeOffset date, WeekDay weekDay, CalendarRecurrenceRule pattern)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetAbsWeekDaysMonthly(DateTimeOffset date, CalendarRecurrenceRule pattern, WeekDay weekDay)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetAbsWeekDaysWeekly(DateTimeOffset date, CalendarRecurrenceRule pattern, WeekDay weekDay)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetOffsetDates(IEnumerable<DateTimeOffset> dates, int offset)
        {
            switch (offset)
            {
                case 0:
        ...
        private static IEnumerable<DateTimeOffset> GetHourVariants(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern, bool? expand)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetMinuteVariants(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern, bool? expand)
        {
        ...
        private static IEnumerable<DateTimeOffset> GetSecondVariants(IEnumerable<DateTimeOffset> dates, CalendarRecurrenceRule pattern, bool? expand)
        {
        ...
        private static void IncrementDate(ref DateTimeOffset dt, CalendarRecurrenceRule pattern, int interval)
        {
            if (interval == 0)
                return;
        ...
        /// <returns></returns>
        public static IEnumerable<CalendarPeriod> Evaluate(CalendarRecurrenceRule rule, DateTimeOffset referenceDate, DateTimeOffset? periodStart, EvaluationOptions? options)
        {
            options ??= new();
        ...
        {
            List<DateTimeOffset> exdates = exceptionDates?.ToList() ?? [];
            return Evaluate(rrule, dtstart, periodStart, new()
            {
